...
CREATE TABLE promissoria (
   ...
   -- FAZER OUTRA TRIGGER PARA QUE, AO EXCLUIR A PROMISSORIA, ADICIONAR A qtdVendida A qtEstoque
...
CREATE TABLE venda (
   ...
   -- AO FAZER ISSO, FAZER UMA TRIGGER PARA DIMINUIR A qtdESTOQUE A PARTIR DA QUANTIDADE VENDIDA)
