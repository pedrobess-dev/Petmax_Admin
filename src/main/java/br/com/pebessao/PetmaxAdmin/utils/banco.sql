...
CREATE TABLE venda (
   ...
   -- QUANTIDADE VENDIDA, AO FAZER ISSO, FAZER UMA TRIGGER PARA DIMINUIR A qtdESTOQUE
   -- A PARTIR DA QUANTIDADE VENDIDA)
...
); -- FAZER A CONVERSÃO PARA QUE O SPRING SECURITY USE A CLASSE DE USUÁRIO PARA REALIZAR O LOGIN
   -- FAZER A RESTRIÇÃO DE MÓDULOS POR PAPEL DE USUÁRIO
...
-- GERAR RELATÓRIOS
-- BUSCAR FORNECEDORES POR MEIO DE API (QUASE FINALIZADO, FALTA SALVAR NA TABELA DE fornecedor e FORMATAR DADOS DE BUSCA)
-- CNPJ Teste: 43996693000127